...
The _Random Forest_ mechanism extends the boosted aggregation technique on the classification/regression trees. This method, although is a bit more complex than the decision tree approach, it is one of the most accurate prediction mechanisms used.
